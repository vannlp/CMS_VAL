                  ...
                  <div class="flex-grow-1">
                    <div class="row">
                      <div class="col-md-8">
                        ...
                        <div class="mb-2 d-flex flex-wrap"><span class="me-1 text-body">Sold by:</span> <a href="javascript:void(0)" class="me-4">Google</a> <span class="badge bg-label-success rounded-pill mt-2 mt-sm-0">In Stock</span></div>
                      ...
                      <div class="col-md-4">
                        <div class="text-md-end">
                          ...
                          <div class="mt-4 mt-md-6 mb-md-0"><span class="text-primary">$299/</span><s class="text-body">$359</s></div>
                          <button type="button" class="btn btn-sm btn-outline-primary mt-4">Move to wishlist</button>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="flex-grow-1">
                    <div class="row">
                      <div class="col-md-8">
                        ...
                        <div class="mb-2 d-flex flex-wrap"><span class="me-1 text-body">Sold by:</span> <a href="javascript:void(0)" class="me-4">Apple</a> <span class="badge bg-label-success rounded-pill mt-2 mt-sm-0">In Stock</span></div>
                        <div class="read-only-ratings mb-2 px-0" data-rateyo-read-only="true"></div>
                        <input type="number" class="form-control form-control-sm w-px-100" value="1" min="1" max="5">
                      </div>
                      <div class="col-md-4">
                        <div class="text-md-end">
                          <button type="button" class="btn text-muted p-0 shadow-none btn-pinned border-none" aria-label="Close"><i class="ri-close-line"></i></button>
                          <div class="mt-4 mt-md-6 mb-md-0"><span class="text-primary">$899/</span><s class="text-body">$999</s></div>
                          <button type="button" class="btn btn-sm btn-outline-primary mt-4">Move to wishlist</button>
                        </div>
                      </div>
                    </div>
