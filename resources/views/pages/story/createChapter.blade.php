...
@section('title', 'Thêm mới Chapter')
...
@section('content')
<h4 class="mb-1">Thêm mới chapter</h4>
...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{route('admin.story.storeChapter')}}" method="post" id="create_storyChapter_form" >
            @csrf
...
<div class="card mt-4">
  <div class="card-body">
    <div class="row mt-3">
      <div class="col-12">
        <button class="btn btn-primary waves-effect waves-light" type="submit" form="create_storyChapter_form">{{__("app.base.create")}}</button>
      </div>
    </div>
  </div>
</div>
